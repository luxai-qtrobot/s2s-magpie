...
class Qwen3TTSHandlerArguments:
    ...
    qwen3_tts_backend: Literal["ggml", "torch"] = field(
        default="torch",
        metadata={
            "help": "faster-qwen3-tts backend on non-macOS platforms. Options: 'torch' or 'ggml'. Default is 'torch'. Install the qwen-ggml extra to use GGML. On Apple Silicon, mlx-audio is selected automatically and this option is ignored."
        },
    )
