...
class RealtimeService:
    ...
    Each PipelineUnit owns one instance. Per-session response and audio state
    is keyed by the registered session id, independently of its transport.
    """
...
def build_error_event(message: str, error_type: str) -> RealtimeErrorEvent:
    """Construct a RealtimeErrorEvent without service-instance state."""
